 ...
 * @project_name : nezuko-Md By zenitsu
 * @author : Godzenitsu <https://github.com/godzenitsu>
...
cmd({
	...
	pattern: "alive",
        ...
        async(Void, citel, text, isAdmins) => {
            let alivemessage = Config.ALIVE_MESSAGE || `*ᴀ ʙᴏᴛ ᴅᴇᴠᴇʟᴏᴘᴇᴅ ʙʏ ɢᴏᴅ-ᴢᴇɴɪᴛꜱᴜ🌚.*`
            const alivtxt = `
